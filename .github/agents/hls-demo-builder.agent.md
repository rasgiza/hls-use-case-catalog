...
- Before writing any Microsoft capability, standard, or limit the catalog does not state, confirm it on Microsoft Learn through the Microsoft Learn MCP server. If it cannot be confirmed, keep the reference at the level the catalog supports.
