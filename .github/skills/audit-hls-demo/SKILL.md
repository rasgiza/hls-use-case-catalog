...
6. Compare visible claims, workloads, buyer language, and workflow purpose with the catalog record. Check any Microsoft capability, standard, or limit the demo asserts against Microsoft Learn with the Microsoft Learn MCP server, and report an unverifiable product claim as a finding.
